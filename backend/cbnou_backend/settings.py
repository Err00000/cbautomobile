"""
Django settings for cbnou_backend project.
...
# ALLOWED_HOSTS is read from a comma-separated environment variable.
...
ROOT_URLCONF = 'cbnou_backend.urls'
...
WSGI_APPLICATION = 'cbnou_backend.wsgi.application'
